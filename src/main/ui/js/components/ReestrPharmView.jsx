...
export default class ReestrPharmView extends Component {
    constructor (props) {
        super(props);
    ...
    render () {
        ...
        const breadcrumbs = !this.state.currentPrms
            ? [ {title : 'Реестр лицензий на фармацевтическую и медицинскую деятельность'} ]
            : [ {title : 'Реестр лицензий на фармацевтическую и медицинскую деятельность',
                onClick : () => { this.setState({ currentPrms : null }) }}, {title : `${this.state.currentPrms.L_NUM}`} ];
        return (
            <div className="mdlp-main-view-container">
                ...
                <div className="mdlp-main-view-workspace">
                    <div className="mdlp-main-view-workspace-leftbar">
                        <ReestrSubMenu menuKey="REESTR_PHARM" />
                        {
                    ...
                    </div>
                    {
                        !this.state.currentPrms ? (
                            ...
                            <div className="mdlp-main-view-workspace-area">
                                <ReestrPharmViewItem prms={ this.state.currentPrms } getData={ itemCardRequestData } fullInfo={ itemCard } />
                            </div>
                        )
                    }
                </div>
...
class ReestrPharmViewItem extends Component {
    componentWillMount () {
        !!this.props.getData && this.props.getData( appRequests.GET_REESTR_ITEM_PHARM(this.props.prms) );
    }
    render () {
        ...
        return !!Object.keys( fullInfo || {} ).length && (
                <div>
                    ...
                    <CardItemInfoBlock>{[
                        ...
                        { title : 'Адрес объекта', value : fullInfo['OBJECTS'].PLACE },
