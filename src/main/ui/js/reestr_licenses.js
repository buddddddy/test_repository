...
import ReestrLicensesView        from './components/ReestrLicensesView.jsx';
...
function main (appInfo, userInfo) {
    ...
    const filterModel = new FilterModel({
        userId : userInfo.id,
        name   : 'reestr_esklp',
        rest   : appRequests.GET_REESTR_LICENSES,
        params : [
    ...
    const View = MDLPContainer('events', { ...filterActions, ...ItemCardActions }, ReestrLicensesView);
    /* Grid table columns */
    const columns = [
